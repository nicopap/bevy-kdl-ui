...
impl Bindings {
    ...
    pub(crate) fn exports(self, scope_name: String, exposed: &[(&str, &str)]) -> Self {
...
impl Binding {
    pub(crate) fn new(node: SpannedNode, bindings: Bindings) -> (Binding, Vec<Spanned<Error>>) {
